...
<body><% UserJPA us= (UserJPA)request.getAttribute("user"); %>
...
<br><br>
<br><center>
<a href="./listall2"><button><h3>BOOK INVENTORY</h3></button></a>
<a href="./transaction"><button><h3>BOOK TRANSACTION</h3></button></a>
<div><a href="./logout2"><button><h3>LOGOUT</h3></button></a></div></center>
</body>
</html>